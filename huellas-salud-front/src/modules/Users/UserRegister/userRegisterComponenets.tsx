...
import logoHSUserRegister from "../../../assets/Huellas&Salud_3.png";
import { InputFieldUserRegister } from "../../../services/typesHS";
...
export const FormUserRegister = () => (
    <section className={styles.containerForm}>
        ...
        <form className={styles.formRegister}>
            ...
            <InputField nombre="Número de documento" type="number" idInput="numDoc" required />
            ...
            <p className={`${styles.inputFull} ${styles.errorMsg}`}>⚠️ Mensaje de error de validación ⚠️</p>
...
export const InfoUserRegister = () => (
    <aside className={styles.userRegisterData}>
        <img src={logoHSUserRegister} alt="Huellas&Salud" />
        <p>¡Únete a la familia de Huellas y Salud!</p>
    </aside>
);

const InputField = (props: InputFieldUserRegister) => {
